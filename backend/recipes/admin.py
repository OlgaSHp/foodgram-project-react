...
from .recipes_consts import EMPTY_MESSAGE
...
class RecipeAdmin(admin.ModelAdmin):
    list_display = (
        'id', 'get_author_username', 'get_author_email',
        'name', 'short_description',
        'cooking_time', 'get_tags', 'get_ingredients', 'get_html_photo',
        'pub_date', 'get_favorite_count')
    list_display_links = ('get_author_email',
                          'get_author_username', 'short_description',)
    search_fields = (
        'name', 'cooking_time',
